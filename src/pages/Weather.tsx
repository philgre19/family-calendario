...
export default function Weather() {
  ...
  // S'assurer que la hauteur de la carte est définie correctement et que le composant est monté
  useEffect(() => {
    const mapContainer = document.getElementById("weather-map");
    if (mapContainer) {
      mapContainer.style.height = "calc(100vh - 200px)";
    }
    // Indique que le composant est monté et prêt pour le rendu
    setMapReady(true);
  }, []);
    ...
    return (
      <MainLayout>
        <div className="container py-6">
          ...
          <div className="w-full h-[calc(100vh-200px)] flex items-center justify-center bg-gray-100 rounded-lg">
